...
data= {
        ...
        'callCount': '1',
        'page': '/jyzd/typezpxx/42020201.html',
        'c0-scriptName': 'portalAjax',
        'c0-methodName': 'getNewsXml',
        'c0-id': '0',
        'c0-param0': 'string:4202',
        'c0-param1': 'string:42020201',
...
def nepu_news():
    ...
    url = 'http://glbm3.nepu.edu.cn/jyzd/dwr/call/plaincall/portalAjax.getNewsXml.dwr'
